...
function inter_page_meta_box_build( $post ){
	...
	<div class='inside'>
		...
		<p>
			<input type="radio" name="page_layout" value="0" <?php checked( $current_page_layout, '0' ); ?> /> Boxed 
			<input type="radio" name="page_layout" value="1" <?php checked( $current_page_layout, '1' ); ?> /> Full Width
		</p>
		<hr>
		...
		<p>
			<input type="radio" name="sidebar_position" value="0" <?php checked( $current_sidebar_position, '0' ); ?> /> Left 
			<input type="radio" name="sidebar_position" value="1" <?php checked( $current_sidebar_position, '1' ); ?> /> Right
		</p>
		<hr>
