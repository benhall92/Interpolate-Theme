...
function inter_breadcrumbs() {
    ...
    if ( !is_front_page() ) {
        ...
        // Home page
        echo '<li class="item-home breadcrumb-item"><a class="bread-link bread-home" href="' . get_home_url() . '" title="' . $home_title . '">' . $home_title . '</a></li>';
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            ...
            echo '<li class="item-current breadcrumb-item">' . $custom_tax_name . '</li>';
            ...
            if(!empty($last_category)) {
                echo $cat_display;
                echo '<li class="item-current breadcrumb-item">' . get_the_title() . '</li>';
                  
            // Else if post is in a custom taxonomy
            } else if(!empty($cat_id)) {
                  
                echo '<li class="item-cat breadcrumb-item"><a href="' . $cat_link . '" title="' . $cat_name . '">' . $cat_name . '</a></li>';
                echo '<li class="item-current breadcrumb-item">' . get_the_title() . '</li>';
            ...
            if( $post->post_parent ){
                ...
                foreach ( $anc as $ancestor ) {
                    $parents .= '<li class="item-parent breadcrumb-item"><a title="' . get_the_title($ancestor) . '">' . get_the_title($ancestor) . '</a></li>';
                }
            ...
            echo '<li class="item-current breadcrumb-item">' . $get_term_name . '</li>';
            ...
            // Day display
            echo '<li class="breadcrumb-item item-current item-' . get_the_time('j') . '">' . get_the_time('jS') . ' ' . get_the_time('M') . ' Archives</li>';
            ...
            echo '<li class="breadcrumb-item item-current item-current-' . get_the_time('Y') . '">' . get_the_time('Y') . ' Archives</li>';
