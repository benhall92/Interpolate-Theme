...
$page_layout 		= $inter_options['archive-layout'];
$show_sidebar 		= $inter_options['archive-show-sidebar'];
$sidebar_position 	= $inter_options['archive-sidebar-position'];
$show_header 		= $inter_options['archive-show-header'];
$show_title 		= $inter_options['archive-show-title'];
$show_breadcrumbs 	= $inter_options['archive-show-breadcrumbs'];
